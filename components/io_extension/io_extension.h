...
#define IO_EXTENSION_IO_5                                                      \
  0x05 // IO5 (Select communication interface: 0 for USB, 1 for CAN)
...
void IO_EXTENSION_Output(uint8_t pin,
                         uint8_t value); // Set IO pin output (high/low)
